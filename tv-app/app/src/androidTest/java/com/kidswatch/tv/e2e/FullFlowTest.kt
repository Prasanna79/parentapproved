...
class FullFlowTest {
    ...
    fun e2e_fullReset_clearsEverything() = runBlocking {
        ...
        com.kidswatch.tv.data.events.PlayEventRecorder.init(db)
        db.playEventDao().insert(com.kidswatch.tv.data.events.PlayEventEntity(
    ...
    fun e2e_offlineMode_togglesCorrectly() {
        assertFalse(com.kidswatch.tv.util.OfflineSimulator.isOffline)
        com.kidswatch.tv.util.OfflineSimulator.toggle()
        assertTrue(com.kidswatch.tv.util.OfflineSimulator.isOffline)
        com.kidswatch.tv.util.OfflineSimulator.toggle()
        assertFalse(com.kidswatch.tv.util.OfflineSimulator.isOffline)
    }
}
